...
function generateNodeCallIntoScopeScript() {
    return `{
...
// properties directly.
function generateBunCallIntoScopeScript() {
    return `{
...
class ReusableVMWorkflowCreator {
    ...
    registeredActivityNames) {
        ...
        node_vm_1.default.runInContext(bun_1.isBun ? generateBunCallIntoScopeScript() : generateNodeCallIntoScopeScript(), this._context, {
