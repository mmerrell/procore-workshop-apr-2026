...
exports.TERMINATED_EXIT_CODE = bun_1.isBun ? 0 : 1;
/**
...
class WorkerThreadClient {
    ...
    async destroy() {
        ...
        const exitCode = await (bun_1.isBun ? this.terminateWithBunWorkaround() : this.workerThread.terminate());
...
class VMWorkflowThreadProxy {
    ...
    async activate(activation) {
        const output = await this.workerThreadClient.send({
            ...
            activation: bun_1.isBun ? proto_1.coresdk.workflow_activation.WorkflowActivation.encode(activation).finish() : activation,
            runId: this.runId,
        });
