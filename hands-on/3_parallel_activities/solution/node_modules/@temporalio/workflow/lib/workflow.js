    ...
    return new Promise((resolve, reject) => {
        ...
        activator.pushCommand({
            scheduleActivity: {
                ...
                versioningIntent: (0, versioning_intent_enum_1.versioningIntentToProto)(options.versioningIntent), // eslint-disable-line @typescript-eslint/no-deprecated
    ...
    const startPromise = new Promise((resolve, reject) => {
        ...
        activator.pushCommand({
            startChildWorkflowExecution: {
                ...
                searchAttributes: options.searchAttributes || options.typedSearchAttributes // eslint-disable-line @typescript-eslint/no-deprecated
                    ? { indexedFields: (0, payload_search_attributes_1.encodeUnifiedSearchAttributes)(options.searchAttributes, options.typedSearchAttributes) } // eslint-disable-line @typescript-eslint/no-deprecated
                    : undefined,
...
function upsertSearchAttributes(searchAttributes) {
    ...
    if (Array.isArray(searchAttributes)) {
        ...
        activator.mutateWorkflowInfo((info) => {
            ...
            const newSearchAttributes = { ...info.searchAttributes }; // eslint-disable-line @typescript-eslint/no-deprecated
            for (const pair of searchAttributes) {
                if (pair.value == null) {
                    ...
                    newSearchAttributes[pair.key.name] = Array.isArray(pair.value)
                        ? pair.value
                        : [pair.value]; // eslint-disable-line @typescript-eslint/no-deprecated
                }
            }
            return {
                ...info,
