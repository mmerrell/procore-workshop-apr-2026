...
class WorkflowClient extends base_client_1.BaseClient {
    ...
    async createStartWorkflowRequest(input) {
        ...
        return {
            ...
            searchAttributes: opts.searchAttributes || opts.typedSearchAttributes // eslint-disable-line @typescript-eslint/no-deprecated
                ? {
                    indexedFields: (0, payload_search_attributes_1.encodeUnifiedSearchAttributes)(opts.searchAttributes, opts.typedSearchAttributes), // eslint-disable-line @typescript-eslint/no-deprecated
                }
                : undefined,
