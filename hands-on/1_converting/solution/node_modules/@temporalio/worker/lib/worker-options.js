...
function defaultSinks(logger) {
    ...
    return { defaultWorkerLogger }; // eslint-disable-line @typescript-eslint/no-deprecated
}
/**
...
function compileWorkerInterceptors({ client, activity, activityInbound, // eslint-disable-line @typescript-eslint/no-deprecated
...
function addDefaultWorkerOptions(options, logger, metricMeter) {
    const { buildId, // eslint-disable-line @typescript-eslint/no-deprecated
